                ...
                <section id="register" className="detailSection">
                    ...
                    {item.attributes.lei.data != null ? (
                        <p id="lei" className="my-2">
                            ...
                            <Link href={'/lei/'+item.attributes.lei.data.attributes.pageslug} className="font-semibold text-primary hover:underline hover:underline-offset-4">{item.attributes.lei.data.attributes.identifier}</Link>
                        </p>
                    ) : ''}
                </section>
